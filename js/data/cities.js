...
(function () {
  ...
  // 브라우저에서는 전역(window), Node(server.js · Vercel 함수)에서는 module.exports 로 같은 설정을 공유
  const root = typeof window !== 'undefined' ? window : globalThis;
  root.SB_ROUTE_TYPES = SB_ROUTE_TYPES;
  root.SB_CITIES = SB_CITIES;
  if (typeof module !== 'undefined' && module.exports) module.exports = { SB_ROUTE_TYPES, SB_CITIES };
})();
